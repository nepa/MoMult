...
/**
 ************************************* !!! LAB EXERCISE !!!  *************************************
 * We shall continue our exploration lists but this time with the Spinner view.  The Spinner view
 ...
 * 			Hints:
 * 				- Note that you use the id attribute to identify each view. The id of a view must start with
 *          the "@+id/" specifier followed by the name of the view.
 ...
 * 		TODO 5.5 Define ArrayAdapter called "adapter" by using ArrayAdapter(Context CurrentContext,
 *             int android.R.layout.simple_spinner_item, String[] YourArray) and set this adapter to the s1.
 * 			Hints:
 * 				-  android.R.layout.simple_spinner_item is a reference to an built-in XML layout document that is
 *           part of the Android OS, rather than one of your own XML layouts.
 *		TODO 5.6 Review event listener setOnItemSelectedListener and complete onItemSelected callback method
 *             implementation to show the name of the selected president in a toast message.
 *		TODO 5.7: Change the spinner look and feel to drop down by changing to android.R.layout.simple_spinner_items
 *              layout and see the difference in appearance
 */
public class MySpinnerViewsActivity extends Activity
{
  ...
  // *** YOUR CODE HERE ***	
  //===================================================================================
  private String[] names = new String[] { "Bart", "Lisa", "Homer", "Marge", "Maggie" };  
  //===================================================================================
  ...
  public void onCreate(Bundle savedInstanceState)
  {
    ...
    // *** YOUR CODE HERE ***	
    //===================================================================================
    this.setContentView(R.layout.spinnerviews);
    ...
    {
      /*
       * Implement onItemSelected to listen to all select events on the spinner done
       * by the user. This method will be called when an item in the list is selected.
       */
