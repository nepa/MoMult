 ...
 * 				- You do not need to refer in your code to the list defined in your layout xml file as the activity extends
 *          ListActivity and this activity has the defined xml layout file.
 * 			TODO 4.3.1 Define an array of 10 items presenting some famous presidents names as the source of our list view
 * 			TODO 4.3.2 Set the list adapter by using ArrayAdapter(Context CurrentContext, int android.R.layout.simple_list_item_1,
 *                 String[] YourArray)
 * 
 * 				Hints:
 * 					-  android.R.layout.simple_list_item_1 is a reference to an built-in XML layout document that is part of the
 *             Android OS, rather than one of your own XML layouts.
...
public class MyListViewsActivity extends ListActivity
{
  ...
  public void onCreate(Bundle savedInstanceState)
  {
    ...
    // *** YOUR CODE HERE ***	
    //===================================================================================	
    this.setContentView(R.layout.listviews);
    
    this.setListAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, this.names));
  }

  /*
   * Implement onListItemClick to listen to all click events on the list done by the user.
  ...
  public void onListItemClick(ListView parent, View v, int position, long id)
  {
    ...
    // *** YOUR CODE HERE ***	
    //===================================================================================	
    DisplayToast((String)this.getListView().getItemAtPosition(position));
    //===================================================================================    
  }
